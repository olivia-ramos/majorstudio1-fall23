...
mapboxgl.accessToken = 'pk.eyJ1IjoicmVhZHlsZXRzZ28iLCJhIjoiY2t0dTR2aGNjMXd3bDJubWgwcWwzcWJzMyJ9.4Qpfc2HBPT14KIrBhX0XGQ';
  ...
  var map = new mapboxgl.Map({
    ...
    center: [-96, 37.8],// this will be the center of map. if you go to google maps and find place you want as center, right click and copy lat/long. 
    zoom: 1
  });
  ...
  async function loadData() {
    ...
    new mapboxgl.Marker(el)
      ...
      .setPopup(new mapboxgl.Popup({ offset: 25 }) // add popups. instead of title. we're feeding the name in the next line of code. 
